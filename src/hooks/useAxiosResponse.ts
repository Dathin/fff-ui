...
export interface UseAxiosResponse <RES, REQ = undefined> {
...
export function useAxiosResponse <RES, REQ = undefined> (request: (data?: REQ) => Promise<AxiosResponse<RES>>): UseAxiosResponse<RES, REQ> {
